...
ebtel: ebtel_functions_loop.o ebtel_functions_param.o ebtel_functions_util.o ebtel_functions_solvers.o ebtel_functions_heating.o ebtel_main.o 
	$(CC) $(CFLAGS) ebtel_functions_loop.o ebtel_functions_param.o ebtel_functions_util.o ebtel_functions_solvers.o ebtel_functions_heating.o ebtel_main.o -o ebtel -lm
...
ebtel_functions_heating.o: ebtel_functions_heating.c
	$(CC) -c  $(CFLAGS) ebtel_functions_heating.c
